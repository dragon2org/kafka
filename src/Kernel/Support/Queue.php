...
namespace SEKafka\Kernel\Support;


use Pimple\Container;
use SEKafka\Kernel\Exception\InvalidPayloadException;
use SEKafka\Kernel\Contract\Queue as QueueContract;
...
abstract class Queue implements QueueContract
{
    ...
    public function getJobRetryDelay($job)
    {
        ...
        $delay = $job->retryAfter ? $job->retryAfter : $job->retryAfter();
    ...
    public function getJobExpiration($job)
    {
        ...
        $expiration = $job->timeoutAt ? $job->timeoutAt : $job->retryUntil();
